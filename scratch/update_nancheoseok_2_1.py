...
def get_commentary_key(verse_num):
    if 92 <= verse_num <= 93:
        local_idx = verse_num - 92 + 1
        return 5, f"5.{local_idx}"
    elif 94 <= verse_num <= 95:
        local_idx = verse_num - 94 + 1
        return 6, f"6.{local_idx}"
    elif 96 <= verse_num <= 128:
        local_idx = verse_num - 96 + 1
        return 7, f"7.{local_idx}"
    elif 129 <= verse_num <= 149:
        local_idx = verse_num - 129 + 1
        return 8, f"8.{local_idx}"
    return None, None
